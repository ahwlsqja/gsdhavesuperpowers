# Reference Specification: Domain Probes

**Name:** `domain-probes`
**Scope:** Domain-specific probing questions organized by technology category for the discuss/brainstorm workflow phase
**Loading Behavior:** Cold-tier — loaded by researcher agent during initial project exploration, by planner agent during discuss-phase facilitation
**Consumers:** Researcher agent (domain-aware requirement elicitation), planner agent (discuss-phase question selection), mapper agent (technology stack identification)
**Research Grounding:** GSD's `domain-probes.md` reference (125 lines); architecture-overview.md §Reference Documents entry 9
