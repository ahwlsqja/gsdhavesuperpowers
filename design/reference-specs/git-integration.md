# Reference Specification: Git Integration

**Name:** `git-integration`
**Scope:** Commit conventions, branching strategies, parallel commit safety, and git history design
**Loading Behavior:** Cold-tier — loaded by executor agent during task completion, by orchestrator during parallel wave coordination
**Consumers:** Executor agent (commit generation), orchestrator agent (parallel safety coordination), verifier agent (commit verification), doc-writer agent (changelog references)
**Research Grounding:** GSD's `git-integration.md` reference (295 lines); architecture-overview.md §Reference Documents entry 6
